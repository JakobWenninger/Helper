...
def pltsettings(save=None,fileformat='.pdf',disp = True,close=False, xlabel='',ylabel='', xlim=None,ylim=None,title=None,yscale=None,legendColumns=1,skip_legend=False):
